      ...
      <div className="slides relative w-full h-full">
        {
          data.length > 0 ? data.map((e, i) => (
            ...
            >
              <div className="flex flex-col mx-8 px-6 gap-2   rounded-lg justify-center items-center lg:w-2/5 lg:h-full lg:bg-teal-800 md:w-full max-lg:h-2/5 lg:bg-gradient-to-br from-slate-800 via-slate-950 to-sky-500 slantBox">
