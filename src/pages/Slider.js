...
const Slider = ({ data }) => {
  ...
  return (
    <div
      className="slider bg-zinc-950 select-none flex justify-center w-full items-center max-md:h-[450px] md:h-[560px]  relative h-full  max-md:min-h-[calc(100vh-101.6px)] md:min-h-[calc(100vh-117.6px)]"
      ...
      <div className="slides relative w-full h-full ">
        {
          data.length > 0 ? data.map((e, i) => (
            ...
            >
              <div className="flex flex-col mx-4 px-6 gap-2   rounded-lg justify-center items-center lg:w-2/5 lg:h-full lg:bg-teal-600 md:w-full max-lg:h-2/5 lg:bg-gradient-to-br from-slate-800 via-slate-950 to-teal-600 slantBox">
                <h1 className="md:text-5xl text-center font-semibold mb-4 relative md:z-50 max-md:text-4xl line-clamp-2">{e.name}</h1>
              ...
              <div className="flex justify-center items-center md:w-3/5 md:h-full max-md:h-[250px] max-md:w-[220px]">
            ...
            >
              <div className="flex flex-col px-6 gap-2 rounded-lg justify-center items-center lg:w-2/5 lg:h-full lg:bg-teal-600 md:w-full max-lg:h-2/5 slantBox">
        ...
        <div className="absolute right-3 top-1/2 transform -translate-y-1/2 flex flex-col space-y-2" style={{zIndex:'200'}}>
          <button
            onClick={prevSlide}
            className="w-8 h-8 max-lg:rounded-full bg-teal-600/20 lg:bg-teal-600/75 text-white rounded-md flex items-center justify-center shadow-md hover:bg-teal-600"
          >
            <NavigateBeforeIcon />
          </button>
          <button
