...
const Product = ({id,name,desc,price,thumbnail}) => {
  ...
  return (
    <NavLink to={`${applicationBaseUrl}/product/${id}`} className='my-2 mx-[6px] w-[calc(16.66%-12px)] max-476:w-[calc(50%-12px)] max-md:w-[calc(33.33%-12px)] max-xl:w-[calc(20%-12px)] max-2xl:w-[calc(13.66%-12px)]   flex flex-col hover:h-full items-center shadow-md overflow-hidden   transition-all group' >
